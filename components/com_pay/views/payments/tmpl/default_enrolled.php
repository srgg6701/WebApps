...
<fieldset id="users-profile-params">
	<legend>Зачисления</legend>
<form action="<?php echo JRoute::_('index.php?option=com_pay&view=payment'); ?>" method="post" name="adminForm" id="adminForm">
	...
	<table class="balance">
		...
		$model = $this->getModel();
		?>
		<?php $this->items = $model->getListQuery('enrolled'); ?>
	...
	<input type="submit" name="delete_form_pay" value="Удалить отмеченные"/>
</form>
</fieldset>