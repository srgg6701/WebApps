...
class PayViewPayments extends JView
{
	...
	{
		require_once JPATH_COMPONENT.DS.'helpers'.DS.'pay.php';

		$state	= $this->get('State');
		$canDo	= PayHelper::getActions($state->get('filter.category_id'));

		JToolBarHelper::title(JText::_('COM_PAY_TITLE_PAYMENTS'), 'payments.png');

        //Check if the form exists before showing the add/edit buttons
        $formPath = JPATH_COMPONENT_ADMINISTRATOR.DS.'views'.DS.'payment';
