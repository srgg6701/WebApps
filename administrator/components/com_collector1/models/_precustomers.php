 ...
 */
class Collector1Model_precustomers extends JModelList
{
    ...
    public function __construct($config = array())
    {
        if (empty($config['filter_fields'])) {
            $config['filter_fields'] = array(
                ...
                'phone', 'a.phone',
                'skype', 'a.skype',
                'collections_ids', 'a.collections_ids',
	...
	protected function getListQuery()
	{
		...
		if (!empty($search)) {
			if (stripos($search, 'id:') === 0) {
                ...
                $query->where('( a.name LIKE '.$search.'  OR  a.email LIKE '.$search.'  OR  a.phone LIKE '.$search.'  OR  a.skype LIKE '.$search.' )');
			}
		}
